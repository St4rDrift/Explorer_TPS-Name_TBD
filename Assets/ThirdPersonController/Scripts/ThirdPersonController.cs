...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float SprintMultiplier = 2.6675f;

        [Tooltip("Whether the character is sprinting")]
        ...
        private void Move()
        {
            // set target speed based on move speed, sprint multiplier and if sprint is pressed
            if (!Sprinting && _inputHandler.SprintTriggered) Sprinting = true;
            else if (Sprinting && _inputHandler.SprintTriggered) Sprinting = false;
            ...
            float inputMagnitude = Sprinting ? 1f : _inputHandler.MoveInput.magnitude;
            ...
            if (currentHorizontalSpeed == 0.00f) Sprinting = false;
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_inputHandler.JumpTriggered && _jumpTimeoutDelta <= 0.0f)
                {
